$(document).ready(function () {
    ...
    $("#tblUser").bootstrapTable({
        url: domain + '/Admin/Users/GetDataUser',
        ...
        columns: [
            {
                ...
                formatter: function (value, row, index) {
                    return '\
                                        ...
                                        <a class="edit ml10" href="'+ domain + '/Admin/Users/Update/' + row.Id + '" title="Edit User">\
                        ...
                        modal.LoadAjax({
                            ...
                            onload: function (modalPopup) {
                                $("#frmResetPass").on("submit", function () {
                                    ...
                                    _AjaxPost(domain+"/Admin/Users/ResetPassword", data, function (rs) {
                                        if (rs.success) {
                    ...
                    'click .remove': function (e, value, row, index) {
                        modal.DeleteComfirm({
                            callback: function () {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: domain+'/admin/users/delete/' + row.Id,

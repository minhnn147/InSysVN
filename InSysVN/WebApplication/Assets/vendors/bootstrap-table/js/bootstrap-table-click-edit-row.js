...
(function ($) {
    ...
    function updateToServerSide(item, data) {
        ...
        //Send to the server side of the Data generated by the need to manually modify the corresponding form
        var datas = { 'treeId': itemid, 'oldTreeSerialNo': data[0], 'adminDivision': data[2], 'adminUnit': data[3], 'treeAddr': data[1] }; 

...
namespace Framework.Data
{
    ...
    public class ADOProvider : IDisposable
    {
        ...
        public virtual List<T> GetAll<T>(IFieldPredicate predicate = null) where T : class
        {
        ...
        public virtual List<T> GetPage<T>(IFieldPredicate predicate = null, IList<ISort> sort = null, int page = 0, int resultsPerPage = 10) where T : class
        {

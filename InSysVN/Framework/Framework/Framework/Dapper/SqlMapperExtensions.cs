    ...
    public static class SqlMapperExtensions
    {
        ...
        class ProxyGenerator
        {
            ...
            public static T GetInterfaceProxy<T>()
            {
                ...
                var interfaceType = typeof(Framework.Extensions.SqlMapperExtensions.IProxy);
            ...
            private static MethodInfo CreateIsDirtyProperty(TypeBuilder typeBuilder)
            {
                ...
                var getMethod = typeof(Framework.Extensions.SqlMapperExtensions.IProxy).GetMethod("get_" + "IsDirty");
                var setMethod = typeof(Framework.Extensions.SqlMapperExtensions.IProxy).GetMethod("set_" + "IsDirty");
